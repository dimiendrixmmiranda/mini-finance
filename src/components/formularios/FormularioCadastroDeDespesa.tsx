...
export default function FormularioCadastroDeDespesa({nomeDaDespesa, setNomeDaDespesa, tipoDaDespesa, setTipoDaDespesa, valorDaVenda, setValorDaVenda, data, setData, categoria, setCategoria, formaDePagamento, setFormaDePagamento}: FormularioCadastroDeDespesaProps) {
    return (
